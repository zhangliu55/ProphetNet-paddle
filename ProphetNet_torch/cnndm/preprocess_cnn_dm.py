...
# preocess('original_data/dev.article', 'prophetnet_tokenized/valid.src', keep_sep=False)
# preocess('original_data/dev.summary', 'cnndm/prophetnet_tokenized/valid.tgt', keep_sep=True)
preocess('original_data/test.article', 'prophetnet_tokenized/test.src', keep_sep=False)
preocess('original_data/test.summary', 'prophetnet_tokenized/test.tgt', keep_sep=True)
