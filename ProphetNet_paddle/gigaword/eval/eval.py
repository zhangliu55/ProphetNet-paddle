...
# Required parameters
parser.add_argument("--gold", default="gigaword/original_data/test.tgt.txt",type=str, help="Gold output file.")
parser.add_argument("--pred", default="gigaword/sort_hypo_ck7_pelt1.0_test_beam4.txt",type=str, help="Input prediction file.")
